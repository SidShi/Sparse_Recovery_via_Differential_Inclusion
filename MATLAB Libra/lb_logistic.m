function object = lb_logistic(X,y,kappa,alpha,alpha0_rate,tlist,nt,trate,intercept,group,index,print,meanx,normx)
% helper function for lb algorithm, used when the distribution is binomial
...
lblogistic_void(X,row,col,y,kappa,alpha,alpha0_rate,result_r,group_split,group_split_length...
