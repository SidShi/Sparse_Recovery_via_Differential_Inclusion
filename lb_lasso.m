function object = lb_lasso(X,y,kappa,alpha,alpha0_rate,tlist,nt,trate,intercept,group,index,print)
...
solution = coder.ceval('LB_lasso',X,row,col,y,kappa,alpha,alpha0_rate,result_r,group_split,group_split_length...
